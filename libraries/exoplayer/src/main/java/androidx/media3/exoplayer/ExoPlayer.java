...
public interface ExoPlayer extends Player {
  ...
  class CrossfadeConfiguration {
    ...
    /**
     * Форма кривой по умолчанию: логарифм на нарастание, экспонента на затухание —
     * слышимый переход, а не наложение. Для ровного перекрытия без провала
     * громкости в середине передавайте {@link #CURVE_CONSTANT_POWER}.
     */
